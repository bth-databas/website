...
I denna övningen skall vi använda oss av programemringsspråket CSharp och koppla upp oss mot en befintlig databas. Vi kommer ställa frågor mot databasen med SELECT och hnatera resultatet för att presentera rapporter för användare.
