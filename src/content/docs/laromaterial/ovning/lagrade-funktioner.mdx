---
title: "⚠️ Övning: Lagrade funktioner i databas" 
description: "Övning för att använda egendefinierade funktioner i databas."
author: mos
revision:
    "2026-02-16": "(A, mos) Första versionen utifrån en befintlig artikel https://dbwebb.se/kunskap/egen-definierade-funktioner-i-databas."
sidebar:
    order: 0700
---
...
Dagens ämne är alltså egendefinerade funktioner i databasen och det bygger vidare på koncepten om lagrade procedurer och "compund statements".
...
Artikeln visar grunderna i [Stored Function](https://mariadb.com/docs/server/server-usage/stored-routines/stored-functions) som kan skrivas med [compund statements](https://mariadb.com/docs/server/reference/sql-statements/programmatic-compound-statements).
