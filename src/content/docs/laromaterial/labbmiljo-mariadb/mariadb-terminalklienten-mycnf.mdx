...
Normalt sett kan du placera filen `.my.cnf` i din hemmakatalog i den terminal du använder. En punkt framför filnamnet gör filen till en "dold fil". Dolda filer visas inte när man gör `ls`, man behöver göra `ls -a` för att visa dem.
