---
title: "⚠️ Kmom06: ER fysisk + Triggers"
description: Avslute ER-modelleringen och lär dig om begreppet triggers.
revision:
...
* CRUD via terminalklienten?
* INSERT ON DUPLICATE KEY UPDATE?
* OUTER JOIN, UNION, subquery
...
Vi sluför ER-modellen med fokus på fysisk modellering. Vi skapar SQL-kod som kan skapa databasens schema och vi lägger in grunddata i databasen.
...
1. Övning med att fylla en databas från excelark.
