...
* Jobba igenom övningen med databasen World.
...
* Verktyg för modellering: dbdiagram.io?
* Modellering av databasen world
* Datatyper i SQL?
...
1. ⚠️ Jobba igenom övningen [Databasen World](/website/laromaterial/ovning/databasen-world/). Övningen går igenom hur du kan använda en befintlig databas (world) och skapa SQL-frågor mot den med både terminalklienten och desktopklienten.
